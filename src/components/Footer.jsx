      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            >
              ...
              <p className="text-zinc-400 mb-6 leading-relaxed">
                Transform your workflow with our AI-powered SaaS platform. Scale
                your business beyond limits with enterprise-grade security and
                performance.
              </p>
        ...
        >
          ...
          <div className="flex items-center text-zinc-400 text-sm">
            ...
            <motion.a
              href="http://websitesbymasud.vercel.app/"
              target="_blank"
              rel="nofollow"
              style={{ color: "#08CB00", textDecoration: "underline" }}
              className="ml-1"
              whileHover={{ scale: 1.05 }}
            >
              Masud
